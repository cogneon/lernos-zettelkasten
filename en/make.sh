...
# Variables
filename="lernOS-Zettelkasten-Guide-en"
set chapters=./src/index.md ./src/1-1-Lebenslanges-Lernen-und-Wissensarbeit.md ./src/1-2-lernOS-Canvas.md ./src/1-3-lernOS-Flow.md ./src/1-4-lernOS-Workplace.md ./src/1-5-lernOS-Memex.md ./src/2-0-PKM-Grundlagen.md ./src/2-0-Lernpfad-Ueberblick.md ./src/2-1-Kata-0.md ./src/2-1-Kata-1.md ./src/2-1-Kata-4.md ./src/2-1-Kata-3.md ./src/2-1-Kata-5.md ./src/2-1-Kata-6.md ./src/2-1-Kata-7.md ./src/2-1-Kata-8.md ./src/2-1-Kata-9.md ./src/2-1-Kata-10.md ./src/2-1-Kata-11.md ./src/2-1-Kata-12.md ./src/2-1-Kata-13.md ./src/3-0-2-was-ist-markdown.md ./src/3-0-1-proprietaeres-Format-zu-MD.md ./src/3-0-3-Guide-PKM-mit-OneNote.md ./src/3-0-0-Danksagung.md ./src/3-0-99-Aenderungshistorie.md
